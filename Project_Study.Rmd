...
m.c = BM.cinema_admissions$Estimate[1, 1]     
p.c = BM.cinema_admissions$Estimate[2, 1]    
q.c = BM.cinema_admissions$Estimate[3, 1]   

# OTT Subscriptions
BM.ott_subscriptions<-BM(ott_cinema_annual$ott_subscriptions_M*1e6, display = T)
m.o = BM.ott_subscriptions$Estimate[1, 1]  
p.o = BM.ott_subscriptions$Estimate[2, 1]
q.o = BM.ott_subscriptions$Estimate[3, 1]
